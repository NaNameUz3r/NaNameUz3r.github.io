...
Средоточие и исток любой парадигмы программирования.
<!--more-->
...
Без изучения декларативной модели глубоко понять программирование в принципе невозможно, потому что эта модель является **фундаментальной** — истоком, из которого возникли все остальные парадигмы. Хорошее понимание декларативной модели автоматически дает возможность быстрее разобраться в других технологиях программирования.
