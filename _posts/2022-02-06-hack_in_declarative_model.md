...
Декларативную парадигму часто противопоставляют императивной. В императивной парадигме всё крутится вокруг *состояний* (переменных), и мы последовательно описываем шаги, которые исполнитель (компуктер), должен выполнить для достижения нашей задачи. Короче говоря мы придумываем и подробно описываем алгоритм.
...
Чувствуете красоту строгости этих декларативных переменных? Фишка декларативных переменных в том, что создание переменной не есть та же операция, что и связывание этой переменной со значением. Мы не можем использовать переменную пока у неё нет значения. Попытка это сделать приведет к ошибке!
