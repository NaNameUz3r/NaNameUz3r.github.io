...
Самый простой способ реализовать такой финт — донести булевое поле в определение Node:
...
А список создавать при помощи функции-генератора, которая будет добавлять и линковать два дурочка:
